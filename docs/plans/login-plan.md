...
graph TD
    ...
    subgraph "External"
        NeoFeederAPI[(Neo Feeder<br/>WS API<br/>neofeeder.stiem-bongaya.ac.id)]
    end
...
class NeoFeeder extends BaseConfig
{
     ...
     */
    public string $baseURL = 'https://neofeeder.stiem-bongaya.ac.id/ws/live2.php';
...
# NEO FEEDER API
#--------------------------------------------------------------------
NEO_FEEDER.baseURL = https://neofeeder.stiem-bongaya.ac.id/ws/live2.php
...
graph LR
    ...
    subgraph "External"
        NeoAPI[Neo Feeder API<br/>neofeeder.stiem-bongaya.ac.id]
    end

...
**.env additions**:
```ini
neofeeder.apiBaseUrl = https://neofeeder.example.com/ws/live2.php
...
**Base URL**: `https://neofeeder.example.com/ws/live2.php`
...
**Request**:
```
POST https://neofeeder.example.com/ws/live2.php
Content-Type: application/json
